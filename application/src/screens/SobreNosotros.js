...
const SobreNosotros = () => {
  return (
    <div name="SobreNosotros" className= {styles.home}> 
      ...
      <p>La innovación es parte de nuestro ADN. Estamos constantemente actualizando nuestras plataformas para ofrecer una 
      ...
      <p>El objetivo del juego es evitar que la persona caiga al suelo.</p>
      <p className='h4'>Pasos</p>
      <p>1- Al principio de la jugada, el jugador tendra x segundos para digitar el monto a apostar y presionar el botón de apostar.
      </p>
      <p>2- Luego de los x segundos, comienza la jugada y el multiplicador comenzará a aumentar.</p>
